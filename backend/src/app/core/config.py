...
class DatabaseSettings(BaseSettings):
    ...
    STORAGE_TYPE: str = Field(default="postgres", description="Storage type: postgres or memory")
    POSTGRES_SERVER: str = Field(default="localhost", description="PostgreSQL server")
    POSTGRES_PORT: int = Field(default=5432, description="PostgreSQL port")
    POSTGRES_DB: str = Field(default="interview_insight_db", description="PostgreSQL database name")
