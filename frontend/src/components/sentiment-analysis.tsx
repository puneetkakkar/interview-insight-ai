              ...
              <CardContent className="space-y-2.5">
                {sentiment.highlights.map((highlight, index) => (
                  <motion.div
                    ...
                    className="flex items-start gap-2 rounded-md border border-emerald-200/40 bg-emerald-50/40 p-3 dark:border-emerald-800/40 dark:bg-emerald-900/10"
                  >
              ...
              <CardContent className="space-y-2.5">
                {sentiment.lowlights.map((lowlight, index) => (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.9 + index * 0.06 }}
                    className="flex items-start gap-2 rounded-md border border-amber-200/40 bg-amber-50/40 p-3 dark:border-amber-800/40 dark:bg-amber-900/10"
                  >
